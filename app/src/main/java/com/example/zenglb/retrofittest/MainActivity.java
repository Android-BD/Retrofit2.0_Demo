...
//                getWeather();
    ...
    private void Login(){
        ...
        loginParams.setPassword("zxcv12340");
...
//        4.
        ...
        Call<LoginResponse> call = loginApi.goLogin(loginParams); //
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {    //
                if(response.isSuccessful()){                    // code:[200,300）
                    ...
                    if(responseCode==HttpClient.HTTP_SUCCESS){
                        textView.setText(response.body().getResult().toString());   //if code is not go to the end,why jump
                    }else{
                        //dispose error case;
