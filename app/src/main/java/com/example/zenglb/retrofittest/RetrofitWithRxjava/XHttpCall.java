...
import com.example.zenglb.retrofittest.RetrofitWithRxjava.param.XLoginParams;
...
//            loggingInterceptor.setLevel(BuildConfig.DEBUG ? HttpLoggingInterceptor.Level.BODY : HttpLoggingInterceptor.Level.NONE);
    ...
    public interface ApiService {
        ...
        Call<XHttpResponse<XEasyResult>> checkMobile(@Path("mobile") String mobile);

        /**
         * 登录
         */
        @POST("api/lebang/oauth/access_token")
        Call<XHttpResponse<XLoginResult>> goLogin(@Body XLoginParams loginParams);  //设置一下Header！do call

        /**
         * 登陆后请求校验身份
         */
        @GET("api/lebang/staffs/apply/identities")
        Call<XHttpResponse<List<XIdentifyResult>>> getIdentities();
